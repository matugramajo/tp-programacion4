...
namespace Cerrajeria.Controllers
{
    ...
    public class ReservasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Telefono,Direccion,ServicioId,FechaHora,Observaciones")] Reserva reserva)
        {
            reserva.Estado = "Pendiente";
            reserva.UsuarioId = User.Identity?.Name;
